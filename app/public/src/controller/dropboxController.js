class DropBoxController {
    ...
    connectFirebase() {
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyC5bsAZaLFNFb-9lBwbYzylXBo2MKABZD0",
            authDomain: "dropbox-clone-paulofrancis.firebaseapp.com",
            databaseURL: "https://dropbox-clone-paulofrancis.firebaseio.com",
            projectId: "dropbox-clone-paulofrancis",
            storageBucket: "dropbox-clone-paulofrancis.appspot.com",
            messagingSenderId: "121581228994",
            appId: "1:121581228994:web:451187144bb2f36841bc5b",
            measurementId: "G-L9PQ5H1EC6"
        };
        // Initialize Firebase
    ...
    initEvents() {
        ...
        this.btnRename.addEventListener('click', event => {
            ...
            let name = prompt('New file name:', file.name);
    ...
    removeFolderTask(ref, name) {
        ...
        let fullPath = ref + '/' + name;

        return new Promise((resolve, reject) => {

            let folderRef = this.getFirebaseRef(fullPath);
            ...
            folderRef.on('value', snapshot => {
                ...
                snapshot.forEach(item => {
                    ...
                    if (data.type === 'folder') {
                        ...
                        this.removeFolderTask(fullPath, data.name).then(() => {
                        ...
                        this.removeFile(fullPath, data.name).then(() => {
